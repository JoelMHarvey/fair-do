    ...
    <footer className="border-t border-sand-200 bg-sand-100/50 mt-auto">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-12">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-xs font-semibold text-sand-900 uppercase tracking-wide mb-3">{footer.col_clients}</h3>
          ...
          <div>
            <h3 className="text-xs font-semibold text-sand-900 uppercase tracking-wide mb-3">{footer.col_tutors}</h3>
            <ul className="space-y-2 text-sm text-sand-600">
          ...
          <div>
            <h3 className="text-xs font-semibold text-sand-900 uppercase tracking-wide mb-3">{footer.col_company}</h3>
            <ul className="space-y-2 text-sm text-sand-600">
