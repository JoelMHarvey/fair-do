...
const SECTIONS: Section[] = [
  {
    ...
    guides: [
      ...
      { id: 'first-steps', q: 'I just signed up — what do I do first?', a: <>Follow the <strong>Getting started</strong> checklist on your <Link href="/therapist/dashboard" className="text-brand-700 underline">dashboard</Link>. It walks you through it: complete your profile, connect payments, add your first client, and book your first session. Each step links straight to the right place.</> },
  ...
  },
  {
    title: 'Your clients',
    guides: [
      { id: 'add-client', q: 'How do I add a client?', a: <>Go to <Link href="/therapist/clients" className="text-brand-700 underline">My clients</Link> and use <strong>Add a client</strong>. Enter their email and an optional rate; they get a secure link to join. To add lots at once, use <strong>Import</strong> and upload a spreadsheet (CSV).</> },
      ...
      { id: 'import-csv', q: 'How do I import my existing client list?', a: <>On <Link href="/therapist/clients/import" className="text-brand-700 underline">Import clients</Link>, download the example spreadsheet, paste in your clients’ names and emails, and upload it. We’ll create them for you. There’s a tip box on that page if you get stuck.</> },
      { id: 'per-client-rate', q: 'Can I charge different clients different prices?', a: <>Yes. Open a client from <Link href="/therapist/clients" className="text-brand-700 underline">My clients</Link> and set their own rate. That’s the price used when you book their sessions. Leave it blank to use your default rate.</> },
    ],
  },
  {
    title: 'Sessions & video',
    guides: [
      { id: 'book-session', q: 'How do I book a session for a client?', a: <>Open the client from <Link href="/therapist/clients" className="text-brand-700 underline">My clients</Link> and use <strong>Schedule a session</strong>. Pick a date and time; we create the private video room and email your client the details automatically.</> },
  ...
  },
  {
    title: 'Getting paid',
    guides: [
      { id: 'connect-payments', q: 'How do I get set up to take payments?', a: <>On your <Link href="/therapist/dashboard" className="text-brand-700 underline">dashboard</Link> (or <Link href="/therapist/billing" className="text-brand-700 underline">Billing</Link>), connect your account with Stripe — our secure payments partner. It’s a short form (your name, bank details, ID). Once done, you can take card payments and get paid out.</> },
      { id: 'when-paid', q: 'When do I receive my money?', a: <>Payouts reach your bank about 2 business days after a completed, paid session. You can see everything on your <Link href="/therapist/earnings" className="text-brand-700 underline">Earnings</Link> page.</> },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-brand-50 via-sand-50 to-sand-50">
      ...
      <div className="max-w-2xl mx-auto px-5 sm:px-8 py-12">
        ...
        <div className="mb-8">
          <HelpHint>New here? The quickest path is the <strong>Getting started</strong> checklist on your <Link href="/therapist/dashboard" className="text-brand-800 underline">dashboard</Link> — it walks you through setup step by step.</HelpHint>
        </div>
