...
const schema = z.object({
  ...
  questionnaire: z.object({
    ...
    previousTherapy: z.boolean().nullable(),
    preferredApproach: z.string().max(100).optional(),
    preferredApproaches: z.array(z.string().max(60)).max(12).optional(),
    availability: z.array(z.string().max(20)).max(7),
    crisisAcknowledged: z.boolean().optional(),
    crisisAcknowledgedAt: z.string().optional(),
  }),
