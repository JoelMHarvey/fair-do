...
export default async function StudioSetupPage() {
  ...
  const steps: Step[] = [
    { title: 'Choose your plan', detail: 'Pick Free, Pro or School — this sets your features.', href: '/teacher/billing', cta: 'Choose a plan', done: hasPlan, tip: 'Your plan decides the small fee we take on each lesson. The Free plan is free to begin with — you can change plan any time.' },
