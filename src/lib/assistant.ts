...
- Plans: **Starter** (free), **Practice** (£29/mo), **Clinic** (for tutoring teams with multiple tutors). Recipient selection on broadcasts, calendar invites, saved templates, branded email letterhead, and earnings insights are paid-tier features.
...
- **Branded letterhead:** Practice/Clinic tutors can brand reservation emails and calendar invites with their own colour, name and logo.
